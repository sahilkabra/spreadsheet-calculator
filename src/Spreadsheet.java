...
/**
 * The main class. Processing begins from here First read all the input from the
 * prompt, then begin evaluation
 *
 * In the first pass, if the value is a number or if it is a Numeric post fix
 * expression, then evaluate it and save the result as the value of the cell
 *
 * In the second pass, if there are any references to cell, resolve them and
 * then evaluate the post fix expression
 *
 * Currently only supports + - / *
 *
 * @throws CycleException
 *             if there are any cycles RuntimeException if the expression given
 *             is invalid
 *
 * @author sahil
 */
